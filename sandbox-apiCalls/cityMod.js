...
$('#button1').on('click', function(){
  ...
  $('#percentHomes').append(national.whereCanIBuy(national.countyHomes, parseFloat($('#income').val().replace(/,/g, '')), parseFloat($('#incomePercent').val()), parseFloat($('#downP').val())));
});

// parseFloat($('#income').val().replace(/,/g, ''));
