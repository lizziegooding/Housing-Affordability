...
function fetchMHV(data, callback){
  console.log(data);
  ...
  affordCountyMHV = calcAffordability(data, value1, value2, value3, value4);
  console.log('affordCountyMHV defined');
  //Init map page
  callback(callback2, initialSalary, source);
  // })
...
function calcAffordability(someData, value1, value2, value3, value4){
  ...
  someData.features.forEach(function(ele){
    ...
    e.mUtilities = 250;
    e.mPropertyTax = salePrice * 0.0129 / 12;
