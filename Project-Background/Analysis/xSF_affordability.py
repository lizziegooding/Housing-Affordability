...
#Output workspace
SF_gdb = r"E:\Active Projects\22505_PHC_Housing_Affordability_Tool\data\geodatabase\SF_affordability.gdb"
...
for s in sflist:
    ...
    arcpy.CalculateField_management(s, "totpy5_"+year, "([Mort5_"+year+"] * 12)+([utilities] * 12) + [ptax_"+year+"] + [insur_"+year+"]", "VB", "")
...
arcpy.CopyFeatures_management("hexlayer_2000",os.path.join(SF_gdb,"SF_affordability_hex_2000_2020"))
