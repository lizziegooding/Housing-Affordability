...
function initialize(){
	...
	//initial view
	var activeLayers = L.layerGroup().addTo(map);
...
var	playButton = document.getElementById('vcr-play');
var	pauseButton = document.getElementById('vcr-pause');
var	refreshButton = document.getElementById('vcr-refresh');
...
/*setButton.addEventListener('click', function(){
	setInterval(function(){skipSlider.noUiSlider.set(2000);}, 3000);
	setInterval(function(){skipSlider.noUiSlider.set(2009);}, 3000);
	setInterval(function(){skipSlider.noUiSlider.set(2010);}, 3000);
...
function next() {
	...
	if (timestamp == 1990 || timestamp == 2000) {
